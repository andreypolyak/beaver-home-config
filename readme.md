...
I also use Ikea Tradfri Driver for lighting in the wardrobe, 1x Gledopto GL-C-008-2ID (horrible device, slow and unreliable) with LED strip mounted under the sofa, 1x Gledopto GL-C-008P (much faster and more reliable) with LED strip mounted under the bed, and Zigbee On/Off Controller to control the integrated bathroom mirror lights. 
